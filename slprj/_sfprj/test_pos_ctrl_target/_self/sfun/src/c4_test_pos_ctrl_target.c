...
static const char * c4_debug_family_names[7] = { "Roll", "Pitch", "Yaw",
  "nargin", "nargout", "R", "Eul" };

/* Function Declarations */
static void initialize_c4_test_pos_ctrl_target
  (SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance);
static void initialize_params_c4_test_pos_ctrl_target
  (SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance);
static void enable_c4_test_pos_ctrl_target
  (SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance);
static void disable_c4_test_pos_ctrl_target
  (SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_test_pos_ctrl_target
  (SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_test_pos_ctrl_target
  (SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance);
static void set_sim_state_c4_test_pos_ctrl_target
  (SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance, const mxArray *c4_st);
static void finalize_c4_test_pos_ctrl_target
  (SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance);
static void sf_gateway_c4_test_pos_ctrl_target
  (SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance);
static void initSimStructsc4_test_pos_ctrl_target
  (SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static void c4_emlrt_marshallIn(SFc4_test_pos_ctrl_targetInstanceStruct
  *chartInstance, const mxArray *c4_Eul, const char_T *c4_identifier, real_T
  c4_y[3]);
static void c4_b_emlrt_marshallIn(SFc4_test_pos_ctrl_targetInstanceStruct
...
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_c_emlrt_marshallIn(SFc4_test_pos_ctrl_targetInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static real_T c4_atan2(SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance,
  real_T c4_y, real_T c4_x);
static void c4_eml_scalar_eg(SFc4_test_pos_ctrl_targetInstanceStruct
  *chartInstance);
static real_T c4_mpower(SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance,
  real_T c4_a);
static void c4_eml_error(SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_d_emlrt_marshallIn(SFc4_test_pos_ctrl_targetInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_e_emlrt_marshallIn(SFc4_test_pos_ctrl_targetInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_test_pos_ctrl_target, const
  char_T *c4_identifier);
static uint8_T c4_f_emlrt_marshallIn(SFc4_test_pos_ctrl_targetInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_test_pos_ctrl_targetInstanceStruct
  *chartInstance);
  ...
  (SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_test_pos_ctrl_target = 0U;
}
  ...
  (SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance)
{
  ...
  real_T (*c4_Eul)[3];
  c4_Eul = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c4_st = NULL;
  c4_st = NULL;
  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_createcellmatrix(2, 1), false);
  for (c4_i0 = 0; c4_i0 < 3; c4_i0++) {
    c4_u[c4_i0] = (*c4_Eul)[c4_i0];
  }

  c4_b_y = NULL;
  sf_mex_assign(&c4_b_y, sf_mex_create("y", c4_u, 0, 0U, 1U, 0U, 1, 3), false);
  sf_mex_setcell(c4_y, 0, c4_b_y);
  c4_hoistedGlobal = chartInstance->c4_is_active_c4_test_pos_ctrl_target;
  ...
  (SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 0)), "Eul",
                      c4_dv0);
  for (c4_i1 = 0; c4_i1 < 3; c4_i1++) {
    (*c4_Eul)[c4_i1] = c4_dv0[c4_i1];
  }

  chartInstance->c4_is_active_c4_test_pos_ctrl_target = c4_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 1)),
     "is_active_c4_test_pos_ctrl_target");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_test_pos_ctrl_target(chartInstance);
  ...
  (SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance)
{
  ...
  real_T (*c4_b_Eul)[3];
  real_T (*c4_b_R)[9];
  c4_b_Eul = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c4_b_R = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  for (c4_i2 = 0; c4_i2 < 9; c4_i2++) {
    _SFD_DATA_RANGE_CHECK((*c4_b_R)[c4_i2], 0U);
  }

  chartInstance->c4_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  for (c4_i3 = 0; c4_i3 < 9; c4_i3++) {
    c4_R[c4_i3] = (*c4_b_R)[c4_i3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 7U, 7U, c4_debug_family_names,
    c4_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_Roll, 0U, c4_c_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_Pitch, 1U, c4_c_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_Yaw, 2U, c4_c_sf_marshallOut,
    c4_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 4U, c4_c_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c4_R, 5U, c4_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_Eul, 6U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 5);
  c4_Roll = c4_atan2(chartInstance, c4_R[5], c4_R[8]);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 6);
  c4_x = c4_mpower(chartInstance, c4_R[5]) + c4_mpower(chartInstance, c4_R[8]);
  c4_b_x = c4_x;
  if (c4_b_x < 0.0) {
  ...
  c4_Pitch = c4_atan2(chartInstance, -c4_R[2], c4_b_x);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 7);
  c4_Yaw = c4_atan2(chartInstance, c4_R[1], c4_R[0]);
  ...
  for (c4_i5 = 0; c4_i5 < 3; c4_i5++) {
    _SFD_DATA_RANGE_CHECK((*c4_b_Eul)[c4_i5], 1U);
  }
}
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance;
  chartInstance = (SFc4_test_pos_ctrl_targetInstanceStruct *)chartInstanceVoid;
  ...
  c4_y[3])
{
  ...
  c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_Eul), &c4_thisId, c4_y);
  sf_mex_destroy(&c4_Eul);
}
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance;
  chartInstance = (SFc4_test_pos_ctrl_targetInstanceStruct *)chartInstanceVoid;
  c4_Eul = sf_mex_dup(c4_mxArrayInData);
  ...
  *c4_inData)
{
  ...
  for (c4_i11 = 0; c4_i11 < 3; c4_i11++) {
    for (c4_i12 = 0; c4_i12 < 3; c4_i12++) {
      c4_b_inData[c4_i12 + c4_i10] = (*(real_T (*)[9])c4_inData)[c4_i12 + c4_i10];
    }
...
const mxArray *sf_c4_test_pos_ctrl_target_get_eml_resolved_functions_info(void)
{
...
static void c4_info_helper(const mxArray **c4_info)
{
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("mpower"), "name", "name", 6);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 8);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("ismatrix"), "name", "name", 8);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 9);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("power"), "name", "name", 9);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_test_pos_ctrl_target), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_test_pos_ctrl_target);
  return c4_y;
}
...
void sf_c4_test_pos_ctrl_target_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_test_pos_ctrl_target_get_autoinheritance_info(void)
{
...
mxArray *sf_c4_test_pos_ctrl_target_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_test_pos_ctrl_target_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_test_pos_ctrl_target(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Eul\",},{M[8],M[0],T\"is_active_c4_test_pos_ctrl_target\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_test_pos_ctrl_target_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_test_pos_ctrl_targetInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c4_Eul)[3];
          c4_Eul = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
          c4_R = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c4_R);
          _SFD_SET_DATA_VALUE_PTR(1U, *c4_Eul);
        }
      }
    } else {
...
static void sf_opaque_initialize_c4_test_pos_ctrl_target(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_test_pos_ctrl_targetInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_test_pos_ctrl_target
    ((SFc4_test_pos_ctrl_targetInstanceStruct*) chartInstanceVar);
  initialize_c4_test_pos_ctrl_target((SFc4_test_pos_ctrl_targetInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_test_pos_ctrl_target(void *chartInstanceVar)
{
  enable_c4_test_pos_ctrl_target((SFc4_test_pos_ctrl_targetInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_test_pos_ctrl_target(void *chartInstanceVar)
{
  disable_c4_test_pos_ctrl_target((SFc4_test_pos_ctrl_targetInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_test_pos_ctrl_target(void *chartInstanceVar)
{
  sf_gateway_c4_test_pos_ctrl_target((SFc4_test_pos_ctrl_targetInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_test_pos_ctrl_target
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_test_pos_ctrl_target
    ((SFc4_test_pos_ctrl_targetInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_test_pos_ctrl_target();/* state var info */
...
extern void sf_internal_set_sim_state_c4_test_pos_ctrl_target(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_test_pos_ctrl_target();/* state var info */
  ...
  set_sim_state_c4_test_pos_ctrl_target((SFc4_test_pos_ctrl_targetInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_test_pos_ctrl_target(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c4_test_pos_ctrl_target(S);
}

static void sf_opaque_set_sim_state_c4_test_pos_ctrl_target(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_test_pos_ctrl_target(S, st);
}

static void sf_opaque_terminate_c4_test_pos_ctrl_target(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_test_pos_ctrl_targetInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_test_pos_ctrl_target((SFc4_test_pos_ctrl_targetInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_test_pos_ctrl_target((SFc4_test_pos_ctrl_targetInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_test_pos_ctrl_target(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c4_test_pos_ctrl_target
      ((SFc4_test_pos_ctrl_targetInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_test_pos_ctrl_target(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c4_test_pos_ctrl_target(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_test_pos_ctrl_target(SimStruct *S)
{
  SFc4_test_pos_ctrl_targetInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_test_pos_ctrl_targetInstanceStruct *)utMalloc(sizeof
    (SFc4_test_pos_ctrl_targetInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_test_pos_ctrl_targetInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_test_pos_ctrl_target;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_test_pos_ctrl_target;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_test_pos_ctrl_target;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_test_pos_ctrl_target;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_test_pos_ctrl_target;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_test_pos_ctrl_target;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_test_pos_ctrl_target;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_test_pos_ctrl_target;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_test_pos_ctrl_target;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_test_pos_ctrl_target;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_test_pos_ctrl_target;
...
void c4_test_pos_ctrl_target_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_test_pos_ctrl_target(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_test_pos_ctrl_target(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_test_pos_ctrl_target(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_test_pos_ctrl_target_method_dispatcher.\n"
